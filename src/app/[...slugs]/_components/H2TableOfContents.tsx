...
const H2TableOfContents = ({ toc }: { toc: Toc }) => {
  ...
  return (
    <section
      ...
      className="hidden lg:block relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-slate-900/60 via-slate-900/40 to-slate-900/10 p-6 text-muted-foreground shadow-[0_35px_60px_-15px_rgba(15,23,42,0.85)] max-w-[220px] w-full mx-auto"
    >
